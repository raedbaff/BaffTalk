...
const { createGroup,getPhoto, fetchAllGroups, fetchPopularGroups, fetchGroupById, joinGroup, getCoverPhoto, fetchGroupsByTopic } = require("../controllers/GroupController");
...
router.get("/group/:topic",fetchGroupsByTopic)
